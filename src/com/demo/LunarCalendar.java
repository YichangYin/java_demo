...
public class LunarCalendar {
    ...
    // 农历部分假日
    final static String[] lunarHoliday = new String[]{"0101 春节", "0115 元宵", "0505 端午", "0707 情人", "0715 中元",
    ...
    public String getLunarDate(int year_log, int month_log, int day_log, boolean isday) {
        ...
        if (!isday) {
            ...
            for (int i = 0; i < solarHoliday.length; i++) {
                ...
                String smonth_v = String.valueOf(month_log);
                String sday_v = String.valueOf(day_log);
                String smd = "";
                if (month_log < 10) {
